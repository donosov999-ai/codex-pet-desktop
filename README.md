...
- 宠物资源库支持按全部、可更新、未安装、已安装筛选，并展示资源包大小和更新时间。
...
控制面板支持从资源库一键安装或更新宠物包、本地导入宠物包、导入前确认、资源库筛选、切换宠物、切换动作状态、调整大小、开启/关闭自动游走、开启/关闭置顶、检查主程序和宠物资源更新、打开下载页、资源目录打开、卸载已导入宠物和退出应用。
